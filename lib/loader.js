...
var _judVueLoader = require('jud-vue-loader');

var _judVueLoader2 = _interopRequireDefault(_judVueLoader);
...
function loader(source) {
  ...
  // Support *.vue files.
  // If file extname is vue then go to `jud-vue-loader`.
  if (_path3.default.extname(this.resourcePath).match(/\.vue/)) {
    return _judVueLoader2.default.call(this, source);
  }

  var options = this.options.jud || {};
  ...
  if (frag.deps.length) {
    ...
    try {
      for (var _iterator = frag.deps[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        var filepath = _path3.default.resolve(_path3.default.dirname(resourcePath), dep + '.ju');
        if (elementNames.indexOf(dep) < 0 && _fs2.default.existsSync(filepath)) {
          output += (0, _util.getRequireString)(this, getLoaderString('none'), './' + dep + '.ju');
        }
      }
    } catch (err) {
  ...
  if (!frag.template.length) {
    ...
    output += 'var __jud_template__ = ' + (0, _util.getRequireString)(this, getLoaderString('template', {
      customLang: customLang,
      lang: template.lang,
      element: isElement,
  ...
  if (frag.style.length) {
    ...
    output += 'var __jud_style__ = ' + (0, _util.getRequireString)(this, getLoaderString('style', {
      customLang: customLang,
      lang: style.lang,
      element: isElement,
      elementName: isElement ? name : undefined,
  ...
  if (frag.script.length) {
    ...
    output += 'var __jud_script__ = ' + (0, _util.getRequireString)(this, getLoaderString('script', {
      customLang: customLang,
      lang: script.lang,
      element: isElement,
      elementName: isElement ? name : undefined,
  ...
  if (isEntry && frag.data.length) {
    ...
    output += 'var __jud_data__ = ' + (0, _util.getRequireString)(this, getLoaderString('data', {
      source: data.src
    }), _src4);
  }
  ...
  if (isEntry && frag.config.length) {
    ...
    output += 'var __jud_config__ = ' + (0, _util.getRequireString)(this, getLoaderString('config', {
      source: _config.src
    }), _src5);
  }

  output += '\n__jud_define__(\'@jud-component/' + name + '\', [], function(__jud_require__, __jud_exports__, __jud_module__) {\n' + (frag.script.length > 0 ? '\n    __jud_script__(__jud_module__, __jud_exports__, __jud_require__)\n    if (__jud_exports__.__esModule && __jud_exports__.default) {\n      __jud_module__.exports = __jud_exports__.default\n    }\n' : '') + '\n    __jud_module__.exports.template = __jud_template__\n' + (frag.style.length > 0 ? '\n    __jud_module__.exports.style = __jud_style__\n' : '') + '\n})\n';
  if (isEntry) {
    output += '\n__jud_bootstrap__(\'@jud-component/' + name + '\'' + (frag.config.length > 0 ? ',__jud_config__' : ',undefined') + (frag.data.length > 0 ? ',__jud_data__' : ',undefined') + ')';
  }
