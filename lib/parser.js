...
var _blocker = require('jud-transformer/lib/blocker');

var _blocker2 = _interopRequireDefault(_blocker);

var _judTemplater = require('jud-templater');

var _judTemplater2 = _interopRequireDefault(_judTemplater);

var _judStyler = require('jud-styler');

var _judStyler2 = _interopRequireDefault(_judStyler);

var _judScripter = require('jud-scripter');

var _judScripter2 = _interopRequireDefault(_judScripter);

var _validator = require('jud-templater/lib/validator');
...
function parseTemplate(source) {
  return new Promise(function (resolve, reject) {
    _judTemplater2.default.parse(source, function (err, obj) {
      if (err) {
        reject(err);
      } else {
...
function parseStyle(source) {
  return new Promise(function (resolve, reject) {
    _judStyler2.default.parse(source, function (err, obj) {
      if (err) {
        reject(err);
      } else {
...
function parseScript(source) {
  return new Promise(function (resolve, reject) {
    var parsed = _judScripter2.default.fix(source);
